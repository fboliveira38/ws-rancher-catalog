...
```
# docker container run -d --name node-exporter -p 9100:9100 -v /proc:/usr/proc -v /sys:/usr/sys -v /:/rootfs infraws/monitoring:node-exporter-1.1.1
```
...
# docker service create --name node-exporter -p 9100:9100 \
   ...
   infraws/monitoring:node_exporter-1.1.1
```
